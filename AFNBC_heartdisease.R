...
for (i in 1:nrow(A)) {
            ...
            beta_age[i]=((n-2)*taw_age[i,(n-1)]+(n-1)*taw_age[i,n])/(taw_age[i,(n-1)]+taw_age[i,n])
...
for (i in 1:nrow(A))
            eta1[i]=(60+77)*0.5*(1-gamma1[i])+(48+71)*0.5*gamma1[i]


d1<- data.frame(betas1,means1,h1,gamma1,eta1)
...
for (i in 1:nrow(A)){
    if(h2[i]==0)       
            eta2[i]=(18+36)*0.5*(1-gamma2[i])+(13+23)*0.5*gamma2[i]
    else if (h2[i]==1)
            eta2[i]=(13+23)*0.5*(1-gamma2[i])+(10+62)*0.5*gamma2[i]
    else 
            eta2[i]=(10+62)*0.5*(1-gamma2[i])
}
...
for (i in 1:nrow(A)){
    if(h3[i]==0)       
            eta3[i]=(226+354)*0.5*(1-gamma3[i])+(210+327)*0.5*gamma3[i]
    else if (h3[i]==1)
            eta3[i]=(210+327)*0.5*(1-gamma3[i])+(215+564)*0.5*gamma3[i]
    else 
            eta3[i]=(215+564)*0.5*(1-gamma3[i])
}
...
for (i in 1:nrow(A)){
    if(h4[i]==0)       
            eta4[i]=(96+202)*0.5*(1-gamma4[i])+(75+190)*0.5*gamma4[i]
    else if (h4[i]==1)
            eta4[i]=(75+190)*0.5*(1-gamma4[i])+(96+194)*0.5*gamma4[i]
    else 
            eta4[i]=(96+194)*0.5*(1-gamma4[i])
}
...
for (i in 1:nrow(A)){
    if(h5[i]==0)       
            eta5[i]=(170+180)*0.5*(1-gamma5[i])+(155+192)*0.5*gamma5[i]
    else if (h5[i]==1)
            eta5[i]=(155+192)*0.5*(1-gamma5[i])+(145+200)*0.5*gamma5[i]
    else 
            eta5[i]=(145+200)*0.5*(1-gamma5[i])+(130+165)*0.5*gamma5[i]
}
...
d<-data.frame(eta1,eta2,eta3,eta4,eta5,A$heart_disease)
k<-which(A$heart_disease=="absence")
l<-which(A$heart_disease=="presence") 
d_absence<-d[k,]
d_presence<-d[l,]
